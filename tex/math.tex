...
\newcommand{\set}[1]{\{#1\}}
\newcommand{\mq}[1]{\mlq #1 \mrq}
\newcommand{\single}[1]{\glq #1 \grq}
\newcommand{\double}[1]{\glqq #1 \grqq}
\newcommand{\oglqq}{\raisebox{-0.10em}{\glqq}} % outer german left double quote
\newcommand{\ogrqq}{\raisebox{0.10em}{\grqq}}
\newcommand{\odouble}[1]{\oglqq\, #1 \,\ogrqq}
