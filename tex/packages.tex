...
\else
  \expandafter\def\expandafter\quote\expandafter{\quote\vspace{-0.6em}\singlespacing}
\fi
...
\else
  ...
  \else
    ...
    \else
      \ifdefined\layoutnice
        \usepackage[top=3cm, bottom=2.9cm, left=3.5cm, right=4cm]{geometry}
      \else
